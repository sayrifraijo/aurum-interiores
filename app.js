  ...
  function renderHero() {
    ...
    return '<section class="hero" id="top">' +
      '<div class="wrap hero__masthead">' +
        (m.logo
          ? '<img class="hero__logo hero__logo--img" src="' + esc(m.logo) + '" alt="' + esc(m.studio) + '">'
      ...
      '<figure class="hero__cover">' +
        '<image-slot id="hero-render" class="hero__render" fit="cover"' + (m.heroRender ? ' src="' + esc(m.heroRender) + '"' : '') + ' placeholder="Render principal del proyecto"></image-slot>' +
